...
public class CalculatorGameStaticMethod {
    ...
    public static void main (String[] args){
       ...
       // Player_a player2 = createPlayer();Player_a player3 = createPlayer();
    ...
    public static int addQuiz(int length){
        ...
        //initial count of true
        //yes I can call a static method within the static method. so use the function in menu that calls static method I want
        int score = 0;
        for(int n = 0; n < length; n++){
            //calling main method addQuestion(2,2) that calls static function

            boolean userinput = addQuestion(2,2); //need to pass through values

            //to count amount of trues

            if (userinput) { //check if true and add score. Userinput == true
                score += 1;
            }
        }
